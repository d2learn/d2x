...
namespace platform_impl {
    ...
    export constexpr std::string_view XLINGS_INSTALL_CMD = "bash -c 'curl -fsSL https://raw.githubusercontent.com/d2learn/xlings/refs/heads/main/tools/other/quick_install.sh | bash || curl -fsSL https://raw.githubusercontent.com/d2learn/xlings/main/tools/other/quick_install.sh | bash'";
